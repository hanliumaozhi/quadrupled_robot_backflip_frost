    ...
    methods
        ...
        function obj = A1(urdf)
            ...
            obj.ContactPoints.rear_right_toe = CoordinateFrame(...
             ...
             %% thigh
             FL_thigh_frame = obj.Joints(getJointIndices(obj, 'FL_thigh_joint'));
             obj.OtherPoints.fl_thigh = CoordinateFrame(...
                 'Name','FrontLeftToe',...
             ...
             FR_thigh_frame = obj.Joints(getJointIndices(obj, 'FR_thigh_joint'));
             obj.OtherPoints.fr_thigh = CoordinateFrame(...
                 'Name','FrontRightToe',...
             ...
             RL_thigh_frame = obj.Joints(getJointIndices(obj, 'RL_thigh_joint'));
             obj.OtherPoints.rl_thigh = CoordinateFrame(...
                 'Name','RearLeftToe',...
             ...
             RR_thigh_frame = obj.Joints(getJointIndices(obj, 'RR_thigh_joint'));
             obj.OtherPoints.rr_thigh = CoordinateFrame(...
                 'Name','RearRightToe',...
